...
public class CongratPanel extends JPanel {
	/**
	 * Create the panel.
	 * 
	 */
	...
	public CongratPanel(int quest, JPanel contentpane) {
		setBounds(0, 0, 800, 800);
		setLayout(null);

		JLabel lblNewLabel = new JLabel("Congratations " + UserInformation.username);
		lblNewLabel.setBounds(246, 87, 414, 60);
		lblNewLabel.setForeground(Color.red);
		add(lblNewLabel);

		JLabel question = new JLabel("You have correct " + quest + " questions.");
